...
// Initial login check and session start
...
if (isset($_GET['error'])) {
    ...
    if ($error == 'invalid_credentials') {
        $errorMessage = 'Invalid username or email, or password. Please try again.';
 ...
 <?php include 'header.php'; ?>
    ...
    <!-- e.g., <i class="fas fa-check-circle"></i> for a check circle icon -->
            ...
            <div class="hero-content">
                ...
                <p>Login now and experience the future of online security</p>
                <?php 
                if (isset($_GET['error'])) {
    if ($error == 'invalid_credentials') {
        $errorMessage = 'Invalid username or email, or password. Please try again.';
        ...
        $errorMessage = 'Invalid form submission. Please try again.';
    } elseif ($error == 'Email+not+verified.+Please+verify+your+email+address+before+logging+in.') {
        $errorMessage = 'Email not verified. Please verify your email address before logging in.';
    }
}
...
?>
            ...
            <div style="background-color: rgb(48, 47, 47);" class="register-form-container">
                <form method="post" action="goprofile.php">
        <h2>Login</h2>
        ...
        <div class="form-group">
            ...
            <input id="username" name="username" placeholder="Enter username or email" required>
        </div>
        <div class="form-group">
    ...
    <a style="margin-bottom:10px" href="forgotpassword.php">Forgot Password?</a>
</div>
    ...
    if (registered === 'true') {
        ...
        loginSuccessMessage.style.marginBottom = '1em';
        loginSuccessMessage.style.display = 'block'; // Ensure the element is visible
    }
